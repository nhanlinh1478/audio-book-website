    ...
    return (
        <>
            ...
            <Container sx={{marginBottom: 4}} component="main" maxWidth="lg">
                        ...
                        <Grid container spacing={4}>
                            <Grid item xs="auto">
                                <Box sx={{ width: 312, height: "auto" }}>
                                    <Avatar variant="square" sx={{ width: 312, height: 312, borderRadius: 6 }} src={Book} />
                                    <div className='pb-4'/>
                            ...
                            <Grid item xs>
                                <Box>
                                    ...
                                    <p className="text-lg pb-4">
                                        Khám phá những địa danh bí ẩn, nhiều ma quỷ nhất trên Thế giới!
                                    </p>
                                    <Button size="large" variant="contained">Phát tất cả</Button>
                                    <div className="pb-8" />
                                    {
                                        unitList.map((item, index) => {
                                            return <UnitItem onClick={() => setActiveItem(index)} key={index} active={activeItem === index}>
                                                <p className="text-lg">
                                                    {item}
                                                </p>
                                            </UnitItem>
                ...
                <div className="pb-8" />
                <Box sx={{ bgcolor: '#3f51b5', height: 'auto', width: '100%', padding: "38px" }}>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs="auto">
                            <Avatar sx={{ width: 136, height: 136 }} src={Book} />
                        </Grid>
                        <Grid item xs>
